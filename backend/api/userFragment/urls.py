...
urlpatterns = [
    ...
    path("update/<int:pk>", views.UserFragmentUpdateView.as_view(), name="user-fragment-update"),
    path("delete/<int:pk>", views.UserFragmentDeleteView.as_view(), name="user-fragment-delete"),
