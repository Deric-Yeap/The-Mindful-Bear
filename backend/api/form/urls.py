...
urlpatterns = [
    ...
    path("get-form-and-questions/<int:pk>", views.FormAndQuestionRetrieveView.as_view(), name="get-form-and-questions"),
    path("update-form-and-questions/<int:pk>", views.FormAndQuestionUpdateView.as_view(), name="update-form-and-questions"),
]
