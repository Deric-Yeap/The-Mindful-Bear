...
class SessionList(generics.ListAPIView):
    ...
    Retrieves all sessions or creates a new session.
    """
    queryset = Session.objects.all()
    serializer_class = SessionSerializer
...
class SessionSplitView(generics.ListAPIView):
    ...
    Retrieves sessions with split details.
    """
    queryset = Session.objects.all()
...
class UpdateSessionDetail(generics.UpdateAPIView):
    """
    Retrieve or Update Session

    Fetches or updates a session without modifying start_datetime.
    """
    queryset = Session.objects.all()
    serializer_class = SessionSerializer
