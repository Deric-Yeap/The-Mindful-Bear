...
#this journal_text is received from the front-end application, where a user submits their journal entry via the app’s interface. 
# The front-end sends this text to the server through an API request (like in journal_views.py).
