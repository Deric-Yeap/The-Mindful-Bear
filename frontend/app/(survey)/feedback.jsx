...
const QuestionaireEnd = () => {
  const { sessionStarted, formData } = useLocalSearchParams(); 
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const filteredForms = response.filter(form => form.is_postsession);
...
export default QuestionaireEnd;
