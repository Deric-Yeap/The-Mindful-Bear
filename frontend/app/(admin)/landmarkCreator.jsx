...
import AssignedExercise from '../../components/assignedExercise';
...
const LandmarkCreator = () =>{
  ...
  const handleSubmit = async () => {
    if (!landmarkName || !exercise || !xCoordinates || !yCoordinates || !imageFile) {
    ...
    try {
      ...
      console.log(error)
      Alert.alert('Error creating landmark:', error.message);
    }
  };
          ...
          <View className="mb-4">
            <Dropdown
              ...
              handleSelect={(selectedValue) => {
                ...
                setExercise(selectedExercise.exercise_id);
              }}
            />
          </View>
          <View className="mb-4">
